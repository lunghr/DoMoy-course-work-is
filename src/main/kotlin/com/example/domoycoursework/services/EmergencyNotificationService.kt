...
//    private var emergencyPostRepository: EmergencyPostRepository,
...
//                emergencyPostRepository.save(emergencyNotificationDto, admin.id)
//            } ?: throw NotFoundException("House not found")
//        } ?: throw NotFoundException("Admin not found")
//    }
//
//    fun sendEmergencyNotification(emergencyPost: EmergencyPost) {
